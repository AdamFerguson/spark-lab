#!/usr/bin/env bash
# nvidia-smi textfile sidecar for node_exporter (DGX Spark GB10, unified memory)
# Source: cadaverine/dgx-spark-observability (scripts/nvidia-smi-textfile.sh)
set -euo pipefail

OUT_DIR="${OUT_DIR:-/var/lib/gpu-textfile}"
