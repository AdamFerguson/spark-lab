...
- **Phase 4 (next):** multi-model config loader (ADR 0004) + backwards-compat v1→v2 upgrade + image abstraction (`images:` map + overrides + `check images`), gated by the parity suite.
